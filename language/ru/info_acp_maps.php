...
$lang = array_merge($lang, array(
	...
	'ACP_MAPS_GROUP_DELETE'				=> 'Кто может удалять метки',
	'ACP_MAPS_GROUP_DELETE_INFO'		=> 'Выберите группы, которые будут иметь возможность удалять метки с карты.',
	...
	'ACP_MAPS_POST'						=> 'Вставлять карту в сообщение',
	'ACP_MAPS_REPUTATION'				=> 'Включить систему репутации меток',
	'ACP_MAPS_REPUTATION_INFO'			=> 'Зарегистрированные пользователи смогут голосовать за метки.',
	'ACP_MAPS_BOUNDS'					=> 'Включить авто позиционирование',
	'ACP_MAPS_BOUNDS_INFO'				=> 'Масштаб карты будет изменён таким образом, что все метки поместятся на карте.',
));
